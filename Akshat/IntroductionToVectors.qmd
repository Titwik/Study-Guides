...
![Graphical representation of Vector $\overrightarrow{AB}$](./Figures/introtovectors-fig1-1.png){fig-alt="Vector $\overrightarrow{AB}$, with arbitrary length, looks like an arrow pointing from $A$ to $B$, where, $A$ is the tail and $B$ is the head." #fig-1}
...
![Graphical representation of Vector $\overrightarrow{BA}$](./Figures/introtovectors-fig2-2.png){fig-alt="Vector $\overrightarrow{BA}$, with arbitrary length, looks like an arrow pointing from $B$ to $A$, where, $B$ is the tail and $A$ is the head." #fig-2}
...
![Visual representation of the two vectors, $\mathbf{a}$ and $\mathbf{b}$, for car A and car B.](./Figures/introtovectors-fig3-3.png){fig-alt="Vectors $\mathbf{a}$ and $\mathbf{b}$ shown with $\mathbf{b}$ being twice $\mathbf{a}$ in the same direction." #fig-3}
...
![The position vector for the point $P$ with respect to the origin](./Figures/introtovectors-fig4-4.png){fig-alt="Position Vector $\overrightarrow{OP}$ with its tail at the origin and head at an arbitrary point $P$." #fig-4}
